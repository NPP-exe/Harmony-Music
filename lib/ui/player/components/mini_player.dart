...
class MiniPlayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // RepaintBoundary isolates the MiniPlayer from the screen beneath it
    // (e.g. Search results), preventing Marquee/text garbling caused by
    // the mini player's frequent repaints polluting the layer below.
    return RepaintBoundary(
      child: Obx(() {
        // This outer Obx ONLY reads isPlayerpanelTopVisible, playerPaneOpacity,
        // and playerPanelMinHeight — things that change during panel slide.
        // currentSong is intentionally NOT read here so that song changes
        // don't cause the whole container to rebuild.
        return Visibility(
          ...
          child: AnimatedOpacity(
            ...
            child: Container(
              ...
              child: Center(
                child: Column(
                  children: [
                    // Progress bar — rebuilds on every position tick,
                    // isolated in its own GetX builder.
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          // Song thumbnail — only rebuilds when currentSong changes
                          Obx(() => Row(
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: ColoredBox(
                                ...
                                // Song title + artist — only rebuilds when currentSong changes
                                child: Obx(() => Column(
                                      mainAxisAlignment:
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: Marquee(
                                            id:
                                                "${playerController.currentSong.value?.id}_mini",
